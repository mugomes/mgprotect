...
**Importante:** Para usar MGProtect corretamente, você precisa gerar previamente a chave pública, a chave interna e o serial utilizando a ferramenta mggenerator. Esta ferramenta garante que os dados de licença sejam assinados e criptografados de forma compatível com MGProtect.
...
A biblioteca pode ser usada em projetos comerciais ou pessoais, mas o uso seguro requer a geração correta das chaves e serial via mggenerator.
